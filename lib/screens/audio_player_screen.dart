...
//     // Load audio from the fetched URL
        ...
        children: [
              ...
              Positioned(
                ...
                child: Slider(
                  ...
                  onChanged: (value) async {
                    ...
                    /// Optional: Play audio if was paused
                    await _audioPlayerService.audioPlayer.resume();
                  },
                ),
              ),
              Positioned(
          ...
          Expanded(
            child: ListView.builder(
              itemBuilder: (ctx, i) => ChangeNotifierProvider.value(
                value: audios[i],
                child: PlayList(audioPlayerService: _audioPlayerService),
              ),
              itemCount: audios.length,
            ),
          ),
